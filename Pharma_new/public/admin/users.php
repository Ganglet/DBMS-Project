...
if (isset($_GET['delete']) && is_numeric($_GET['delete'])) {
    ...
    if ($id != $_SESSION['user_id']) {
        ...
        if ($stmt->execute()) {
            ...
            $error_message = "Error deactivating user";
        }
...
// Get all users
$result = $conn->query("SELECT id, username, full_name, email, role, created_at, last_login, status FROM users ORDER BY id DESC");
?>
<!DOCTYPE html>
<html lang="en">
<head>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="users.php?delete=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to deactivate this user?')">
